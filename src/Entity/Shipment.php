...
class Shipment
{
     ...
     * @return string
     */
    public function getUSPSEndorsment()
    {
        return $this->uspsEndorsment;
    }

    /**
     * @param string $usps_endorsment
     *
     * @return Shipment
     */
    public function setUSPSEndorsment($usps_endorsment)
    {
        $this->uspsEndorsment = $usps_endorsment;
